...
import com.example.prilogulka.DataBase;
import com.example.prilogulka.User;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    //для чего были созданы 2 вспомогательных класса DataBase и User
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                if (myUser.userId > 0) {
                    finish();
                    Intent myIntent = new Intent(LoginActivity.this, MainActivity.class); //логин есть, загружается MainActivity
                            ...
                            switch (which) {
                                case DialogInterface.BUTTON_POSITIVE: //сохранение нового пользователя
                                    ...
                                    try {
                                        ...
                                        myToast.show();
                                        Intent myIntent = new Intent(LoginActivity.this, TwoActivity.class);//новый пользователь переходит к заполнению анкеты
                                        LoginActivity.this.startActivity(myIntent);
                                    } finally {

...
//
//        query += "null," + " '" + user.getEmail() + "'," +
//                " '" + user.getSurname() + " " + user.getName() + " " + user.getLastName() + "'," +
//                " '" + user.getBirthday() + "'," + " '" + user.getLastDateOnline()  + "'," +
//                " '" + user.getSex() + "');";
        Log.i(CLASS_TAG, INSERT_QUERY);
        String query = String.format(INSERT_QUERY, Time.getToday(), user.getEmail(), user.getPassword(),
        user.getEmailCheckCode(), user.getEmailChecked() ? 1 : 0, Time.getTodayTime() + " " + Time.getToday());
